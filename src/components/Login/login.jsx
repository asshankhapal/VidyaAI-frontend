          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative order-2 lg:order-1">
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Sign in to create local-language lessons, generate smart worksheets,
                and craft clear explanations tailored to every learner in your classroom.
              </p>
              ...
              <div className="bg-white rounded-2xl shadow-xl ring-1 ring-gray-100 p-6 sm:p-8">
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    Use your school or email account
                  </p>
                </div>
                ...
                <form className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <button
                      type="button"
                      className="flex items-center justify-center gap-2 w-full border border-gray-300 rounded-lg py-2.5 hover:bg-gray-50 transition"
                    >
