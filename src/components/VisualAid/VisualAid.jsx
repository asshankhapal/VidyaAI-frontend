...
//   // Auto render when mermaidCode changes - FIXED VERSION
//   useEffect(() => {
//     if (mermaidCode && mermaidContainerRef.current) {
//       // Clear the container first to force re-render
//       mermaidContainerRef.current.innerHTML = mermaidCode;
      
//       // Re-initialize mermaid on the container
//       try {
//         mermaid.init(undefined, mermaidContainerRef.current);
//       } catch (error) {
//         console.error("Mermaid rendering error:", error);
//         // Fallback: display the raw code if rendering fails
//         mermaidContainerRef.current.innerHTML = `<pre>${mermaidCode}</pre>`;
//       }
//     }
//   }, [mermaidCode]);
...
//         "http://127.0.0.1:8000/api/v1/visualvisual-aid/",
//         {
//           method: "POST",
//           headers: {
...
//       // Assuming backend returns { mermaid_code: "graph TD ..." }
...
//   // Download output (placeholder, implement later)
